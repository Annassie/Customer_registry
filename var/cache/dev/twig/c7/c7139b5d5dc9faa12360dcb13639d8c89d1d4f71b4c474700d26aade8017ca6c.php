...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@WebProfiler/Collector/cache.html.twig", "/Users/annaniukkanen/symfony/customer_registry/vendor/symfony/web-profiler-bundle/Resources/views/Collector/cache.html.twig");
    }
}
